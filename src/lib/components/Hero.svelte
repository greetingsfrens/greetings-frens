	...
	<nav class="px-6 py-4 shadow">
		<div class="lg:items-center lg:justify-between lg:flex">
			...
			>
				...
				<a
					href="#"
					class="px-3 py-2 text-sm font-semibold text-center text-white transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700"
					>Get Started</a
				>
			</div>
		</div>
	...
	<div class="lg:flex">
		<div class="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] lg:w-1/2">
			<div class="max-w-xl">
				...
				<p class="mt-2 text-sm text-gray-500 dark:text-gray-400 lg:text-base">{content}</p>
