<section class="bg-white dark:bg-gray-800">
	<div class="container px-6 py-8 mx-auto">
		<div class="items-center lg:flex">
			...
			<div class="lg:w-1/2">
				<h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">About Greetings Frens</h2>

				<p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
					Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi ducimus, repudiandae amet
					laborum, incidunt doloremque reiciendis atque possimus beatae laudantium quasi autem
					accusantium nisi, quo nulla numquam esse at iure vel dolores quod dignissimos neque?
					Laborum minus nesciunt earum voluptatem deleniti tempore harum.
				</p>
